...
// ============================================================
// 顶级常量和函数：用于文本标准化（NFD 分解的替代方案）
// ============================================================

// 组合变音符号范围（Unicode Mn 类别的常用子集）
final RegExp _diacriticsRegExp = RegExp(
  r'[\u0300-\u036f\u0483-\u0489\u0591-\u05bd\u05bf\u05c1-\u05c2\u05c4-\u05c7'
  r'\u0610-\u061a\u064b-\u065f\u0670\u06d6-\u06dc\u06df-\u06e4\u06e7-\u06e8'
  r'\u06ea-\u06ed\u0730-\u074a\u0e31\u0e34-\u0e3a\u0e47-\u0e4e'
  r'\u3099\u309a]', // 日语组合浊音/半浊音符号
...
final Map<String, String> _composedToBase = {
...
/// 预组合字符分解（NFD 分解的替代方案）
String _decomposeDiacritics(String text) {
...
String _normalizeJapanese(String text) {
  ...
  // -----------------------------------------------------
  // 4.5: 浊音/半浊音转清音（必须在长音转换之前）
  // 罗马音转换或片假名转换可能产生浊音，需要在长音转换前处理
  // -----------------------------------------------------
  text = _decomposeDiacritics(text);
  text = text.replaceAll(_diacriticsRegExp, '');
